...
ZunResult AnmManager::LoadTextureMipmap(i32 textureIdx, char *textureName, i32 textureFormat, D3DCOLOR colorKey)
{
    ...
    if (D3DXCreateTextureFromFileInMemoryEx(g_Supervisor.d3dDevice, data, g_LastFileSize, 0, 0, 0, 0,
                                            surfaceDesc.Format, D3DPOOL_SYSTEMMEM, 3, 0xFFFFFFFF, colorKey, NULL, NULL,
                                            &textureSrc) != D3D_OK)
    {
        goto err;
    }
